...
- [https://github.com/serialt/lancet/blob/main/cryptor/basic.go](https://github.com/serialt/lancet/blob/main/cryptor/basic.go)
- [https://github.com/serialt/lancet/blob/main/cryptor/encrypt.go](https://github.com/serialt/lancet/blob/main/cryptor/encrypt.go)
...
```go
import (
    "github.com/serialt/lancet/v2/cryptor"
)
```
