...
- [https://github.com/serialt/lancet/blob/main/datastructure/set/set.go](https://github.com/serialt/lancet/blob/main/datastructure/set/set.go)
...
```go
import (
    set "github.com/serialt/lancet/v2/datastructure/set"
)
```
