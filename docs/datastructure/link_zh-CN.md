...
- [https://github.com/serialt/lancet/blob/main/datastructure/link/singlylink.go](https://github.com/serialt/lancet/blob/main/datastructure/link/singlylink.go)
- [https://github.com/serialt/lancet/blob/main/datastructure/link/doublylink.go](https://github.com/serialt/lancet/blob/main/datastructure/link/doublylink.go)
...
```go
import (
    link "github.com/serialt/lancet/v2/datastructure/link"
)
```
