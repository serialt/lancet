...
- [https://github.com/serialt/lancet/blob/main/datastructure/stack/arraystack.go](https://github.com/serialt/lancet/blob/main/datastructure/stack/arraystack.go)
- [https://github.com/serialt/lancet/blob/main/datastructure/stack/linkedstack.go](https://github.com/serialt/lancet/blob/main/datastructure/stack/linkedstack.go)
...
```go
import (
    stack "github.com/serialt/lancet/v2/datastructure/stack"
)
```
