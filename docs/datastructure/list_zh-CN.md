...
- [https://github.com/serialt/lancet/blob/main/datastructure/list/list.go](https://github.com/serialt/lancet/blob/main/datastructure/list/list.go)
...
import (
    "fmt"
    list "github.com/serialt/lancet/v2/datastructure/list"
)
