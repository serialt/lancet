...
- [https://github.com/serialt/lancet/blob/main/datastructure/heap/maxheap.go](https://github.com/serialt/lancet/blob/main/datastructure/heap/maxheap.go)
...
```go
import (
    heap "github.com/serialt/lancet/v2/datastructure/heap"
)
```
