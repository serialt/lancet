...
-   [https://github.com/serialt/lancet/blob/main/random/random.go](https://github.com/serialt/lancet/blob/main/random/random.go)
...
```go
import (
    "github.com/serialt/lancet/v2/random"
)
```
