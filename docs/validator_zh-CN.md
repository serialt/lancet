...
-   [https://github.com/serialt/lancet/blob/main/validator/validator.go](https://github.com/serialt/lancet/blob/main/validator/validator.go)
...
```go
import (
    "github.com/serialt/lancet/v2/validator"
)
```
